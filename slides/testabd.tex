\begin{frame}{Deux niveaux de blindage}
  \begin{figure}[h!tbp]
    \centering
    \subfigure[Niveau 1 de blindage]{\label{level1} \includegraphics[width=.45\linewidth]{figures/Th0.pdf}} \hspace{0.5cm}
    \subfigure[Niveau 2 de blindage]{\label{level2} \includegraphics[width=.45\linewidth]{figures/Th1.pdf}} %\hspace{0.75cm}
